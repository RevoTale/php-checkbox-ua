...
class PaginatedResultShiftModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof \RevoTale\CheckboxUA\Model\PaginatedResultShiftModel;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \RevoTale\CheckboxUA\Model\PaginatedResultShiftModel();

...
use RevoTale\CheckboxUA\Model\{BonusPayload, CardPaymentPayload, CashPaymentPayload, DeliveryPayload, DiscountPayload, IntegrationEditOrderReceiptSchema, ObsoleteCardPaymentPayload, OrderGoodItemModel};

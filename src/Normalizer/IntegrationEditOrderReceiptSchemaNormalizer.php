...
class IntegrationEditOrderReceiptSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && 'RevoTale\\CheckboxUA\\Model\\IntegrationEditOrderReceiptSchema' === get_class($data);
    }
    ...
    {
        return ['RevoTale\\CheckboxUA\\Model\\IntegrationEditOrderReceiptSchema' => false];
    }
}

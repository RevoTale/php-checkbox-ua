...
class CalculatedGoodDetailsPayloadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'RevoTale\\CheckboxUA\\Model\\CalculatedGoodDetailsPayload' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'RevoTale\\CheckboxUA\\Model\\CalculatedGoodDetailsPayload' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \RevoTale\CheckboxUA\Model\CalculatedGoodDetailsPayload();
    ...
    {
        return ['RevoTale\\CheckboxUA\\Model\\CalculatedGoodDetailsPayload' => false];
    }
}

...
use RevoTale\CheckboxUA\Model\{PaginatedResultReceiptModel, PaginatedResultReceiptModelMeta, ReceiptModel};
...
class PaginatedResultReceiptModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'RevoTale\\CheckboxUA\\Model\\PaginatedResultReceiptModel' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data instanceof PaginatedResultReceiptModel;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new PaginatedResultReceiptModel();

...
use RevoTale\CheckboxUA\Model\{GoodModelBase, SrsoSchemaGoodSchemaGoodModel, TaxModel};
...
class SrsoSchemaGoodSchemaGoodModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof SrsoSchemaGoodSchemaGoodModel;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new SrsoSchemaGoodSchemaGoodModel();

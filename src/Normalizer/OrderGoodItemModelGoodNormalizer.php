...
class OrderGoodItemModelGoodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof \RevoTale\CheckboxUA\Model\OrderGoodItemModelGood;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \RevoTale\CheckboxUA\Model\OrderGoodItemModelGood();
    ...
    {
        return [OrderGoodItemModelGood::class => false];
    }
}

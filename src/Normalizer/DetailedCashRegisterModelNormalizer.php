...
use RevoTale\CheckboxUA\Model\{BranchModel, DetailedCashRegisterModel, ShiftWithCashierModel};
...
class DetailedCashRegisterModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof DetailedCashRegisterModel;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new DetailedCashRegisterModel();

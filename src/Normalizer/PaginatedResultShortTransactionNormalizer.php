...
use RevoTale\CheckboxUA\Model\{PaginatedResultShortTransaction, PaginatedResultShortTransactionMeta, ShortTransaction};
...
class PaginatedResultShortTransactionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof PaginatedResultShortTransaction;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new PaginatedResultShortTransaction();

...
use RevoTale\CheckboxUA\Model\{CardPaymentPayload, CashPaymentPayload, CurrencyExchangeSchema, DiscountModel, GoodItemModel, GoodTax, ObsoleteCardPaymentPayload, ReceiptConfigPayload, ReceiptModel, ShiftWithCashierAndCashRegister, ShortTransaction};
...
class ReceiptModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'RevoTale\\CheckboxUA\\Model\\ReceiptModel' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data instanceof \RevoTale\CheckboxUA\Model\ReceiptModel;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (array_key_exists('fiscal_date', $data)) {
            $object->setFiscalDate(null === $data['fiscal_date'] ? null : DateTime::createFromFormat('Y-m-d\\TH:i:s.uP', $data['fiscal_date']));
            unset($data['fiscal_date']);
        }
        if (array_key_exists('delivered_at', $data)) {
            $object->setDeliveredAt(null === $data['delivered_at'] ? null : DateTime::createFromFormat('Y-m-d\\TH:i:s.uP', $data['delivered_at']));
        ...
        if (array_key_exists('sent_dps_at', $data)) {
            $object->setSentDpsAt(null === $data['sent_dps_at'] ? null : DateTime::createFromFormat('Y-m-d\\TH:i:s.uP', $data['sent_dps_at']));
        ...
        if (array_key_exists('currency_exchange', $data)) {
            $object->setCurrencyExchange(null === $data['currency_exchange'] ? null : $this->denormalizer->denormalize($data['currency_exchange'], CurrencyExchangeSchema::class, 'json', $context));
            unset($data['currency_exchange']);
        }
        if (array_key_exists('shift', $data)) {
            $object->setShift($this->denormalizer->denormalize($data['shift'], ShiftWithCashierAndCashRegister::class, 'json', $context));
            unset($data['shift']);
        }
        if (array_key_exists('control_number', $data)) {
            $object->setControlNumber($data['control_number']);
    ...
    public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($object->isInitialized('controlNumber') && null !== $object->getControlNumber()) {

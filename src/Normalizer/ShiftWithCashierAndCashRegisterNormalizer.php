...
use RevoTale\CheckboxUA\Model\{BalanceModel, CashRegisterModel, CashierModel, ReportModel, ShiftTaxModel, ShiftWithCashierAndCashRegister, ShortTransaction};
...
class ShiftWithCashierAndCashRegisterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && $data instanceof \RevoTale\CheckboxUA\Model\ShiftWithCashierAndCashRegister;
    }

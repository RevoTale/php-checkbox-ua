...
class CurrencyExchangeSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\CurrencyExchangeSchema' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\CurrencyExchangeSchema' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Vendor\Library\Generated\CheckboxUA\Model\CurrencyExchangeSchema();
        ...
        if (array_key_exists('sell', $data)) {
            $object->setSell($this->denormalizer->denormalize($data['sell'], 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\CurrencySchema', 'json', $context));
            unset($data['sell']);
        }
        if (array_key_exists('buy', $data)) {
            $object->setBuy($this->denormalizer->denormalize($data['buy'], 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\CurrencySchema', 'json', $context));
            unset($data['buy']);
        }
    ...
    {
        return ['Vendor\\Library\\Generated\\CheckboxUA\\Model\\CurrencyExchangeSchema' => false];
    }
}

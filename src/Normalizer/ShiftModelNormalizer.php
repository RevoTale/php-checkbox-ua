...
use RevoTale\CheckboxUA\Model\{BalanceModel, ReportModel, ShiftModel, ShiftTaxModel, ShortTransaction};
...
class ShiftModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'RevoTale\\CheckboxUA\\Model\\ShiftModel' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data instanceof ShiftModel;
    }

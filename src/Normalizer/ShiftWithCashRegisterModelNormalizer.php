...
use RevoTale\CheckboxUA\Model\{BalanceModel, CashRegisterModel, ReportModel, ShiftTaxModel, ShiftWithCashRegisterModel, ShortTransaction};
...
class ShiftWithCashRegisterModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'RevoTale\\CheckboxUA\\Model\\ShiftWithCashRegisterModel' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data instanceof ShiftWithCashRegisterModel;
    }

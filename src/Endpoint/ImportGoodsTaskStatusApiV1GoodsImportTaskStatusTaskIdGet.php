...
class ImportGoodsTaskStatusApiV1GoodsImportTaskStatusTaskIdGet extends \Vendor\Library\Generated\CheckboxUA\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\CheckboxUA\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $taskId, array $headerParameters = [])
    {
        $this->task_id = $taskId;
    ...
    {
        return str_replace(['{task_id}'], [$this->task_id], '/api/v1/goods/import/task_status/{task_id}');
    }
    ...
    /**
     * @return \Vendor\Library\Generated\CheckboxUA\Model\CheckStatusResponseSchema
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (422 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \Vendor\Library\Generated\CheckboxUA\Exception\ImportGoodsTaskStatusApiV1GoodsImportTaskStatusTaskIdGetUnprocessableEntityException($serializer->deserialize($body, 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\HTTPValidationError', 'json'), $response);
        }

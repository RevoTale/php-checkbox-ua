...
class GetCashRegisterApiV1CashRegistersCashRegisterIdGet extends \Vendor\Library\Generated\CheckboxUA\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\CheckboxUA\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $cashRegisterId, array $headerParameters = [])
    {
        $this->cash_register_id = $cashRegisterId;
    ...
    {
        return str_replace(['{cash_register_id}'], [$this->cash_register_id], '/api/v1/cash-registers/{cash_register_id}');
    }
    ...
    /**
     * @return \Vendor\Library\Generated\CheckboxUA\Model\DetailedCashRegisterModel
     *
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (200 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            return $serializer->deserialize($body, 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\DetailedCashRegisterModel', 'json');
        }
        if (false === is_null($contentType) && (422 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \Vendor\Library\Generated\CheckboxUA\Exception\GetCashRegisterApiV1CashRegistersCashRegisterIdGetUnprocessableEntityException($serializer->deserialize($body, 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\HTTPValidationError', 'json'), $response);
        }

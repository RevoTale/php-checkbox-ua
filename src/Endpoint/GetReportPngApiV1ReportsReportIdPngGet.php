...
class GetReportPngApiV1ReportsReportIdPngGet extends \Vendor\Library\Generated\CheckboxUA\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\CheckboxUA\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $reportId, array $queryParameters = [], array $headerParameters = [])
    {
    ...
    {
        return str_replace(['{report_id}'], [$this->report_id], '/api/v1/reports/{report_id}/png');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['width', 'paper_width']);
        $optionsResolver->setRequired([]);
        $optionsResolver->setDefaults(['width' => 30, 'paper_width' => 58]);
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (422 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \Vendor\Library\Generated\CheckboxUA\Exception\GetReportPngApiV1ReportsReportIdPngGetUnprocessableEntityException($serializer->deserialize($body, 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\HTTPValidationError', 'json'), $response);
        }

...
class GetPeriodicalReportApiV1ReportsPeriodicalGet extends \Vendor\Library\Generated\CheckboxUA\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\CheckboxUA\Runtime\Client\Endpoint
{
    ...
    {
        return '/api/v1/reports/periodical';
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['from_date', 'to_date', 'width', 'is_short']);
        $optionsResolver->setRequired(['from_date', 'to_date']);
        $optionsResolver->setDefaults(['width' => 42, 'is_short' => false]);
        ...
        $optionsResolver->addAllowedTypes('is_short', ['bool']);
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, string $contentType = null)
    {
        ...
        if (false === is_null($contentType) && (422 === $status && false !== mb_strpos($contentType, 'application/json'))) {
            throw new \Vendor\Library\Generated\CheckboxUA\Exception\GetPeriodicalReportApiV1ReportsPeriodicalGetUnprocessableEntityException($serializer->deserialize($body, 'Vendor\\Library\\Generated\\CheckboxUA\\Model\\HTTPValidationError', 'json'), $response);
        }

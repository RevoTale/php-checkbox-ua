...
class TransactionModel extends ArrayObject
{
    /**
     * @var array
     */
     ...
     * @var string
     */
    protected $responseIdSignature;
    /**
     * @var string
     */
    protected $responseDataSignature;
    /**
     * @var string
     */
    ...
    public function getResponseIdSignature(): ?string
    {
        return $this->responseIdSignature;
    }

    public function setResponseIdSignature(?string $responseIdSignature): self
    {
        $this->initialized['responseIdSignature'] = true;
        $this->responseIdSignature = $responseIdSignature;

        return $this;
    }

    public function getResponseDataSignature(): string
    {
        return $this->responseDataSignature;
    }

    public function setResponseDataSignature(string $responseDataSignature): self
    {
        $this->initialized['responseDataSignature'] = true;

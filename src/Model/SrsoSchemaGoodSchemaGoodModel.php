...
class SrsoSchemaGoodSchemaGoodModel extends ArrayObject
{
    /**
     * @var array
     */
    ...
    public function getRelatedBarcodes(): string
    {
        return $this->relatedBarcodes;
    }

    public function setRelatedBarcodes(string $relatedBarcodes): self
    {
        $this->initialized['relatedBarcodes'] = true;
        $this->relatedBarcodes = $relatedBarcodes;

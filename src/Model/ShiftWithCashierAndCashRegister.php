...
class ShiftWithCashierAndCashRegister extends ArrayObject
{
    /**
     * @var array
     */
    ...
    public function getCashRegister(): CashRegisterModel
    {
        return $this->cashRegister;
    }

    public function setCashRegister(CashRegisterModel $cashRegister): self
    {
        $this->initialized['cashRegister'] = true;
        $this->cashRegister = $cashRegister;

        return $this;
    }

    public function getCashier(): CashierModel
    {
        return $this->cashier;
    }

    public function setCashier(CashierModel $cashier): self
    {
        $this->initialized['cashier'] = true;

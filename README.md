...
> [!WARNING]
> This repository is archived and no longer maintained. The shop it was used for no longer communicates with Checkbox directly; fiscalization is now handled by a separate service written in Go.
